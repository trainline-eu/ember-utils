minispade.register('ember-data-amplify/~tests/amplify_data_test', function() {
...
minispade.register('ember-geolocation/~tests/geo_location_test', function() {

});
minispade.register('ember-module/~tests/module_test', function() {

});
minispade.register('ember-objectproxy/~tests/object_proxy_test', function() {
var set = Ember.set;
...
minispade.register('ember-routing/~tests/routing_test', function() {
// ==========================================================================
